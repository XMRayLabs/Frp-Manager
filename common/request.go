...
type ReqType interface {
	pb.UpdateFRPCRequest | pb.RemoveFRPCRequest |
		...
		pb.GetProxyStatsByClientIDRequest | pb.GetProxyStatsByServerIDRequest | pb.GetAllProxyStatsRequest |
		pb.CreateProxyConfigRequest | pb.ListProxyConfigsRequest | pb.UpdateProxyConfigRequest |
		pb.DeleteProxyConfigRequest | pb.GetProxyConfigRequest | pb.GetProxyStatusesRequest | pb.GetProxyStatusesRPCRequest | pb.SignTokenRequest |
		...
		pb.GetWireGuardRuntimeInfoRequest | pb.GetWireGuardRuntimeInfosRequest | pb.GetNetworkTopologyRequest
}
