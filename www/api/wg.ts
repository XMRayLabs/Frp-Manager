...
import {
	...
	GetWireGuardRuntimeInfosRequest,
	GetWireGuardRuntimeInfosResponse,
...
export const getWireGuardRuntimes = async (req: GetWireGuardRuntimeInfosRequest) => {
	const res = await http.post(API_PATH + '/wg/runtime/list', GetWireGuardRuntimeInfosRequest.toJson(req))
	return GetWireGuardRuntimeInfosResponse.fromJson((res.data as BaseResponse).body)
}
