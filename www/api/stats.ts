...
import {
  GetAllProxyStatsRequest,
  GetAllProxyStatsResponse,
  GetProxyStatsByClientIDRequest,
  GetProxyStatsByClientIDResponse,
...
export const getAllProxyStats = async () => {
  const res = await http.post(API_PATH + '/proxy/get_all_stats', GetAllProxyStatsRequest.toJson({}))
  return GetAllProxyStatsResponse.fromJson((res.data as BaseResponse).body)
}
