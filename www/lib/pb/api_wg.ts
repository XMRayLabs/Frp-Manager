...
/**
 * @generated from protobuf message api_wireguard.GetWireGuardRuntimeInfosRequest
 */
export interface GetWireGuardRuntimeInfosRequest {
    /**
     * @generated from protobuf field: optional uint32 network_id = 1;
     */
    networkId?: number;
}
/**
 * @generated from protobuf message api_wireguard.GetWireGuardRuntimeInfosResponse
 */
export interface GetWireGuardRuntimeInfosResponse {
    /**
     * @generated from protobuf field: optional common.Status status = 1;
     */
    status?: Status;
    /**
     * @generated from protobuf field: map<uint32, wireguard.WGDeviceRuntimeInfo> runtime_infos = 2;
     */
    runtimeInfos: {
        [key: number]: WGDeviceRuntimeInfo;
    };
}
/**
...
// @generated message type with reflection information, may provide speed optimized methods
class GetWireGuardRuntimeInfosRequest$Type extends MessageType<GetWireGuardRuntimeInfosRequest> {
    constructor() {
        super("api_wireguard.GetWireGuardRuntimeInfosRequest", [
            { no: 1, name: "network_id", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<GetWireGuardRuntimeInfosRequest>): GetWireGuardRuntimeInfosRequest {
        const message = globalThis.Object.create((this.messagePrototype!));
        if (value !== undefined)
            reflectionMergePartial<GetWireGuardRuntimeInfosRequest>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetWireGuardRuntimeInfosRequest): GetWireGuardRuntimeInfosRequest {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional uint32 network_id */ 1:
    ...
    internalBinaryWrite(message: GetWireGuardRuntimeInfosRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional uint32 network_id = 1; */
        if (message.networkId !== undefined)
            writer.tag(1, WireType.Varint).uint32(message.networkId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message api_wireguard.GetWireGuardRuntimeInfosRequest
 */
export const GetWireGuardRuntimeInfosRequest = new GetWireGuardRuntimeInfosRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetWireGuardRuntimeInfosResponse$Type extends MessageType<GetWireGuardRuntimeInfosResponse> {
    constructor() {
        super("api_wireguard.GetWireGuardRuntimeInfosResponse", [
            { no: 1, name: "status", kind: "message", T: () => Status },
            { no: 2, name: "runtime_infos", kind: "map", K: 13 /*ScalarType.UINT32*/, V: { kind: "message", T: () => WGDeviceRuntimeInfo } }
        ]);
    }
    create(value?: PartialMessage<GetWireGuardRuntimeInfosResponse>): GetWireGuardRuntimeInfosResponse {
        const message = globalThis.Object.create((this.messagePrototype!));
        message.runtimeInfos = {};
        if (value !== undefined)
            reflectionMergePartial<GetWireGuardRuntimeInfosResponse>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetWireGuardRuntimeInfosResponse): GetWireGuardRuntimeInfosResponse {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* optional common.Status status */ 1:
                    message.status = Status.internalBinaryRead(reader, reader.uint32(), options, message.status);
                    break;
                case /* map<uint32, wireguard.WGDeviceRuntimeInfo> runtime_infos */ 2:
                    this.binaryReadMap2(message.runtimeInfos, reader, options);
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    private binaryReadMap2(map: GetWireGuardRuntimeInfosResponse["runtimeInfos"], reader: IBinaryReader, options: BinaryReadOptions): void {
        let len = reader.uint32(), end = reader.pos + len, key: keyof GetWireGuardRuntimeInfosResponse["runtimeInfos"] | undefined, val: GetWireGuardRuntimeInfosResponse["runtimeInfos"][any] | undefined;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case 1:
                    ...
                    break;
                case 2:
                    val = WGDeviceRuntimeInfo.internalBinaryRead(reader, reader.uint32(), options);
                    break;
                default: throw new globalThis.Error("unknown map entry field for field api_wireguard.GetWireGuardRuntimeInfosResponse.runtime_infos");
            }
        }
        map[key ?? 0] = val ?? WGDeviceRuntimeInfo.create();
    }
    internalBinaryWrite(message: GetWireGuardRuntimeInfosResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* optional common.Status status = 1; */
        if (message.status)
            Status.internalBinaryWrite(message.status, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
        /* map<uint32, wireguard.WGDeviceRuntimeInfo> runtime_infos = 2; */
        for (let k of globalThis.Object.keys(message.runtimeInfos)) {
            writer.tag(2, WireType.LengthDelimited).fork().tag(1, WireType.Varint).uint32(parseInt(k));
            writer.tag(2, WireType.LengthDelimited).fork();
            WGDeviceRuntimeInfo.internalBinaryWrite(message.runtimeInfos[k as any], writer, options);
            writer.join().join();
        }
        let u = options.writeUnknownFields;
        if (u !== false)
...
/**
 * @generated MessageType for protobuf message api_wireguard.GetWireGuardRuntimeInfosResponse
 */
export const GetWireGuardRuntimeInfosResponse = new GetWireGuardRuntimeInfosResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
