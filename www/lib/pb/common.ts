...
export interface ProxyInfo {
    ...
    firstSync?: boolean;
    /**
     * @generated from protobuf field: optional string origin_client_id = 10;
     */
    originClientId?: string;
}
/**
...
class ProxyInfo$Type extends MessageType<ProxyInfo> {
    constructor() {
        super("common.ProxyInfo", [
            ...
            { no: 10, name: "origin_client_id", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* optional bool first_sync */ 9:
                    ...
                    break;
                case /* optional string origin_client_id */ 10:
                    message.originClientId = reader.string();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: ProxyInfo, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* optional string origin_client_id = 10; */
        if (message.originClientId !== undefined)
            writer.tag(10, WireType.LengthDelimited).string(message.originClientId);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
