...
const (
	...
	Event_EVENT_GET_PROXY_INFO_BATCH       Event = 29
)
...
const file_rpc_master_proto_rawDesc = "" +
	...
	"\x06status\x18\x01 \x01(\v2\x0e.common.StatusR\x06status*\xee\x05\n" +
	"\x05Event\x12\x15\n" +
	...
	"\x12EVENT_UPGRADE_FRPP\x10\x1c\x12\x1e\n" +
	"\x1aEVENT_GET_PROXY_INFO_BATCH\x10\x1d2\x81\a\n" +
	"\x06Master\x12>\n" +
	"\n" +
