...
type ProxyInfo struct {
	...
	OriginClientId    *string                `protobuf:"bytes,10,opt,name=origin_client_id,json=originClientId,proto3,oneof" json:"origin_client_id,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ProxyInfo) GetOriginClientId() string {
	if x != nil && x.OriginClientId != nil {
		return *x.OriginClientId
	}
	return ""
...
const file_common_proto_rawDesc = "" +
	...
	"\n" +
	"first_sync\x18\t \x01(\bH\bR\tfirstSync\x88\x01\x01\x12-\n" +
	"\x10origin_client_id\x18\n" +
	" \x01(\tH\tR\x0eoriginClientId\x88\x01\x01B\a\n" +
	"\x05_nameB\a\n" +
	"\x05_typeB\f\n" +
	"\n" +
	"_client_idB\f\n" +
