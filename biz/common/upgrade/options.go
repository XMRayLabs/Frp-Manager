...
type Options struct {
	...
	// GithubProxy is an explicitly trusted GitHub proxy prefix.
	GithubProxy string
	...
	// ClientOnly selects the smaller client-only release asset.
	ClientOnly bool

	// Relaunch starts the updated executable after an interactive Windows upgrade.
	Relaunch     bool
	RelaunchArgs []string
}
