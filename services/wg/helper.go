...
// parseAndValidatePeerConfigs 鐢熸垚wg UAPI鏍煎紡鐨刾eer閰嶇疆
...
// parseAndValidatePeerConfig 灏唂rpp浣跨敤鐨凱eerConfig杞崲涓簑gtypes.PeerConfig锛岀敤鏉ョ粰wg璁惧浣跨敤
...
func generateUAPIConfigString(cfg *defs.WireGuardConfig,
	...
	// 鍙湪棣栨鍚姩涓旀湭璺宠繃鏃惰缃?listen_port,閬垮厤鍦ㄨ澶囪繍琛屾椂鏇存柊绔彛瀵艰嚧姝婚攣
