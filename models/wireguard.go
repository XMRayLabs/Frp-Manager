...
// AsBasePeerConfig 灏?WireGuard 閰嶇疆杞崲涓?Peer 閰嶇疆
// specifiedEndpoint: 鍙€夊弬鏁帮紝鐢ㄤ簬鎸囧畾浣跨敤鐨?Endpoint銆傚鏋滀负 nil锛屽垯浣跨敤绗竴涓?AdvertisedEndpoint
